    ...
    private class Content extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            for(int i=0;i<contest.size();i++){
                ...
                l = new LinearLayout(com.example.codeinfo.Leetcode.this);
                l.setBackgroundResource(R.drawable.round_corner);
                l.setLayoutParams(param);
                l.setOrientation(LinearLayout.VERTICAL);

                t = new TextView(com.example.codeinfo.Leetcode.this);
                ...
                View tr = new View(com.example.codeinfo.Leetcode.this);
                tr.setLayoutParams(new LinearLayout.LayoutParams( GridLayout.LayoutParams.MATCH_PARENT, 5 ));
                tr.setBackgroundColor(Color.parseColor("#FFFFFF"));
                l.addView(tr);

                l2 = new LinearLayout(com.example.codeinfo.Leetcode.this);
                l2.setOrientation(LinearLayout.HORIZONTAL);
                t1 = new TextView(com.example.codeinfo.Leetcode.this);
                ...
                View tr2 = new View(com.example.codeinfo.Leetcode.this);
                ...
                t2 = new TextView(com.example.codeinfo.Leetcode.this);
                ...
                View tr3 = new View(com.example.codeinfo.Leetcode.this);
                ...
                t3 = new TextView(com.example.codeinfo.Leetcode.this);
